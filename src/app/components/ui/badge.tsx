    ...
    <div
      className={cn(
        "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2",
        {
          ...
          "border-transparent bg-green-100 text-green-700 hover:bg-green-100/80": variant === "success",
          "border-transparent bg-yellow-100 text-yellow-700 hover:bg-yellow-100/80": variant === "warning",
          "border-transparent bg-gray-100 text-gray-500 hover:bg-gray-100/80": variant === "neutral",
        },
        className
      )}
      {...props}
